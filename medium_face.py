...
model_directory = "../model_medium_leave_2"
summary_directory = "../summary_medium_leave_2"
def cnn_model_fn(features, labels, mode):
  ...
  with tf.variable_scope("Dense_Layer"):
      ...
      dropout = tf.layers.dropout(inputs=dense1, rate=0.4, training=mode == tf.estimator.ModeKeys.TRAIN, name="Dropout")
      #dropout = tf.layers.dropout(inputs=dense1, rate=0.4, training=True, name="Dropout")
